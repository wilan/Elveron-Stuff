...
//System.out.println(unitsHome);
	...
	public abstract double getDefense(int i);
	public abstract double extraDP();
	public abstract double extraMods();
	...
	public void parseSOB(Scanner s) throws Exception
	{
		...
		while(true)
		{
			...
			if(buildingName.equals(tavernName()))
			{
	...
	private static final double SHIELD = 5;
	...
	public JTable unitData()
	{
		...
		Object[][] data = new Object[Races.NUMUNITS][columnNames.length];
		double[] minArr = minUnits();
		for(int i = 0; i < Races.NUMUNITS; i++)
		{
